...
public:
	...
	// Parameterized constructor  - Initializes the rectangle with specified width and height, and calculates the  mid-length  property based on the larger dimension for use in collision detection and quadtree inclusion.
	...
	// GetCentrePoint -	Calculates and returns the center point of the rectangle shape for use in spatial partitioning  and collision detection. This method overrides the pure virtual method from the CShape base class.
	...
	// GetHeight -	GetMidLength, GetRadius, and GetWidth - these methods return the height, mid-length, radius (which is the width for a rectangle), and width of the rectangle shape, respectively. These properties are used for rendering, collision detection, and spatial partitioning.
	...
	// GetColor - Return the current fill color of the rectangle shape as an SFML Color object. This method allows for querying the current color of the shape
	...
	// SetRadius - Sets the radius of the rectangle shape, which is equivalent to setting the width for a rectangle. This method overrides the pure virtual method from the CShape base class.
