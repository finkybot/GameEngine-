...
/////////////////////////////////
//	|	SystemManager class - Manages a collection of systems in the game engine, allowing for adding, removing, and updating systems. The SystemManager class provides an interface for managing the lifecycle of systems and coordinating their updates with the EntityManager.
