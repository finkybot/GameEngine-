...
private: // Scene helpers
	...
	RaycastHit MakeStartCellHit(
		int tileX, int tileY,
		const Vec2&
			origin); // Helper to create a synthetic RaycastHit representing an immediate hit at the start cell, since DDA will return no hit in this case
