...
/////////////////////////////////
//	|	TechRegistry class - Manages a collection of technology nodes in the game engine, allowing for adding, retrieving, and checking prerequisites for technology nodes. The TechRegistry class provides an interface for managing the lifecycle of technology nodes and coordinating their interactions.
