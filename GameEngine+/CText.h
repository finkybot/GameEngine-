...
public:
	...
	// Visibility flag for the text. This determines whether the text should be rendered or not. If set to true, the text will be visible and rendered on the screen; if set to false, the text will be hidden and not rendered. The default value is true, meaning the text will be visible by default.
	...
	// Constructor with parameters - initializes the text component with specified text, font key, character size, and color. The font key is used to look up the font in the FontManager, while the character size determines the pixel size of the rendered text. The color parameter allows for setting 
	// a custom color for the text, overriding the default white color.
