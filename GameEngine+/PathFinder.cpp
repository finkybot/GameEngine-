...
//	};
//
//	// Check if start and goal tiles are walkable; if not, return std::nullopt to indicate failure
...
//	}
//
//	// If the goal was not found, return std::nullopt to indicate failure
//	if (!found) {
//		return std::nullopt;
//	}
//
