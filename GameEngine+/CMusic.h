...
public:
	...
	bool playOnStart =
		false; // whether the music should start playing immediately when the component is added to an entity
	bool autoPlay =
		false; // whether the music should automatically play when the component is added to an entity (this can be used in conjunction with playOnStart for more control over when the music starts)
