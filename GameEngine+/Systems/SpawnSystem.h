...
//	|	It also defines enums for spawn types and patterns, as well as component flags to control which components are added to spawned entities.
//	|_______________________________________________________________________
namespace Spawn {
	...
	////////////////////////////
	//	|	Spawn types enumeration defines the different types of spawning behavior that can be configured for a spawner. Burst spawns a set number of entities at once, Continuous spawns entities at a constant rate, and Periodic spawns entities at regular intervals based on a cooldown timer.
	//	|_______________________________________________________________________
	...
	////////////////////////////////
	// |	Spawn patterns enumeration defines the different spatial patterns that can be used for spawning entities. Each pattern determines how the spawned entities are positioned and animated in the game world, allowing for a variety of visual effects and gameplay mechanics.
	// |_______________________________________________________________________
	enum class Pattern {
...
/////////////////////////////////
	...
	//	|	These flags allow for flexible configuration of spawned entities, enabling or disabling visual, sound, physics, transform, and collision components as needed. The default flag includes all components.
	//	|_______________________________________________________________________
	...
	//	|	This struct is used by the SpawnSystem to determine how and when to spawn entities based on the defined configurations. It can be loaded from a JSON file or defined programmatically.
	//	|_______________________________________________________________________
	...
	//	|	It interacts with the EntityManager to create new entities and can be configured to respond to audio levels from the MusicSystem for audio-reactive spawning patterns.
	//	|_______________________________________________________________________
	class SpawnSystem {
	public:
