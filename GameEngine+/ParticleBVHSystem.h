...
/////////////////////////////////
//	|	ParticleBVHNode struct definition. This struct represents a node in the Bounding Volume Hierarchy (BVH) for particles. It contains an axis-aligned bounding box (AABB), indices for the start and count of particles in the node and pointers to left and right child nodes. It also has a method to check if the node is a 
//	|	leaf node (i.e., contains particles).
...
/////////////////////////////////
//	|	ParticleBVHSystem class definition. This class manages a collection of particles and organizes them into a Bounding Volume Hierarchy (BVH) for efficient spatial queries. It provides methods to build the BVH, refit it when particles move, and query for particles within a specified sphere.
//	|_____________________________________________________________________________________
