...
public:
	...
	float zOrder =
		0.0f; // optional layering.... i'll probably need this at some point for rendering order control, but for now it can just default to 0.0f and we can implement layering logic in the render system later if needed.
