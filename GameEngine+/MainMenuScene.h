...
/////////////////////////////////
//	|	MainMenuScene class definition, derived from the base Scene class. This class represents the main menu scene of the game, allowing players to select different scenes to play. It includes methods for updating, rendering, handling events, and managing the scene lifecycle, as well as a reference to the SFML RenderWindow 
//	|	for drawing the menu and a list of available scene names for selection.
