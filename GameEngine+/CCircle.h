...
public:
	...
	// GetMidLength - returns the mid-length property of the circle shape, which is equivalent to the radius. where the mid-length is defined as the distance from the center to the edge of the shape.
