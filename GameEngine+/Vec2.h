...
/////////////////////////////////
//	|	Vec2 class - represents a 2D vector with x and y components, along with various operations for vector arithmetic, normalization, projection, and rotation. This class provides a convenient way to perform common vector operations needed for game development, such as calculating distances, angles, and reflections.
...
public:
	...
	// Inline helper methods for accessing and modifying the x and y components of the vector. These methods provide a convenient way to set and get the individual components of the vector, allowing for easy manipulation and retrieval of vector values in various calculations and operations.
