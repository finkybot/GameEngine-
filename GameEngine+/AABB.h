...
/////////////////////////////////
// AABBIntersectsSphere - Checks if an axis-aligned bounding box (AABB) intersects with a sphere defined by its center (Vec2) and radius (float). This function calculates the closest point on the AABB to the sphere's center and checks if the distance from that point to the center is less than or equal to the radius squared.
