...
/////////////////////////////////
//	|	FileManager class - centralized file management system for loading all types of engine assets (tilemaps, textures, images, configurations, etc.). Provides uniform interface across different file types with built-in caching, error handling, and path resolution.
