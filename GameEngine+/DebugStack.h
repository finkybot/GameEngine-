...
/////////////////////////////////
// LogStack - Logs the current call stack for debugging purposes. This function can be called from anywhere in the code to print the call stack to the console, which can help identify the sequence of function calls leading up to a certain point in the code, especially when debugging crashes or unexpected behavior. 
