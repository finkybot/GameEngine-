...
/////////////////////////////////
//	|	CParticleInfluence component - Represents the influence of a knowledge particle on civilizations within a certain radius. It contains parameters for the influence radius and falloff, allowing for interaction with civilizations and their tech trees.
